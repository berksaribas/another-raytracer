...
set CommonLinkerFlags= -incremental:no -opt:ref gdi32.lib kernel32.lib user32.lib shell32.lib

pushd .\build
cl %CommonCompilerFlags% ..\src\*.cpp /Fetracer.exe /link %CommonLinkerFlags%
popd
